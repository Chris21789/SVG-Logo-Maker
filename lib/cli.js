...
class CLI {
  ...
  run() {
    return inquirer
      ...
      .then(({ characters, charactersColor, shape, shapeColor }) => {
        this.title = `${characters} Logo`;
        this.svg.push({ characters, charactersColor, shape, shapeColor });
        console.log(characters, charactersColor, shape, shapeColor);
